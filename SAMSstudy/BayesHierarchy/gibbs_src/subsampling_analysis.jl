...
#
# Purpose:
#   Repeated SAMS subsampling analysis and calculation of
#   reference MSE metrics for all covariates.
############################################################
...
function fit_repeated_subsamples(
    ...
    for split in splits
        ...
        mlm_train = fit_sams_matrixlm(X_train, Y_train, Z)
        mlm_test = fit_sams_matrixlm(X_test, Y_test, Z)
