# COPDGene Bayesian Hierarchical Model Analysis

Reproducible Julia implementation of the Bayesian Hierarchical Model analysis for the COPDGene metabolomics application presented in the accompanying manuscript.
