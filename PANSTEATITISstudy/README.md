...
The PANSTEATITIS analysis evaluates the stability of metabolite effect estimation across training sizes of `10`, `15`, `20`, and `25`. Each training size is evaluated using 100 repeated complementary training/testing splits by default.
