...
Reproducible Julia implementation of the Bayesian hierarchical model analysis for the PANSTEATITIS Study metabolomics application presented in the accompanying manuscript.
...
This directory contains the reproducible Julia implementation of the Bayesian hierarchical model analysis for the PANSTEATITIS Study metabolomics application presented in the accompanying manuscript. The project is distributed as a self-contained Julia environment and reproduces the manuscript figures, posterior estimates, and numerical summaries for the PANSTEATITIS study.
...
- **BayesHierarchy/**
  ...
  - run_pans_mse.jl : Runs the Bayesian hierarchical model on the PANSTEATITIS metabolomics data and reproduces the estimation and prediction performance reported in the manuscript.
  - run_pans_plot.jl : Generates the manuscript figures for the PANSTEATITIS application.
...
* PANSTEATITIS manuscript figures
